...
@Component({
  selector: 'app-managers-room-ui',
  templateUrl: './managers-room-ui.component.html',
  styleUrls: ['./managers-room-ui.component.css']
})
export class ManagersRoomUiComponent implements OnInit {
